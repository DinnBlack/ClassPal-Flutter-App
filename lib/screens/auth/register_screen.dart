...
import '../../widgets/common_widget/custom_text_field.dart';
import '../../widgets/normal_widget/oval_image.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  final role = AppState.currentRole; // Get the current role
  bool? _isPhone = true;
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Gender field (modified based on role)
                        CustomTextField(
